...
#include "Test/Public/Core/TestGameMode.h"
...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ATestGameMode_Statics::Class_MetaDataParams[] = {
		...
		{ "IncludePath", "Core/TestGameMode.h" },
		{ "ModuleRelativePath", "Public/Core/TestGameMode.h" },
	...
	struct Z_CompiledInDeferFile_FID_Test_Source_Test_Public_Core_TestGameMode_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Test_Source_Test_Public_Core_TestGameMode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ATestGameMode, ATestGameMode::StaticClass, TEXT("ATestGameMode"), &Z_Registration_Info_UClass_ATestGameMode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ATestGameMode), 4167333932U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Test_Source_Test_Public_Core_TestGameMode_h_850445843(TEXT("/Script/Test"),
		Z_CompiledInDeferFile_FID_Test_Source_Test_Public_Core_TestGameMode_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Test_Source_Test_Public_Core_TestGameMode_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
